...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        {
            newNode.Prev = _tail; // Connect the previous newMode to the tail
            _tail.Next = newNode; // Connect new node to the next tail
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // For any other location of 'value', need to connect curr.Prev with a curr.Next 
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue;// If the current data == oldvalue', current data is replaced with newValue
            }
